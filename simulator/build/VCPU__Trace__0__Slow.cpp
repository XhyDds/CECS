...
VL_ATTR_COLD void VCPU___024root__trace_init_sub__TOP__0(VCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBus(c+118,"clk", false,-1, 0,0);
    tracep->declBus(c+119,"rstn", false,-1, 0,0);
    tracep->declBus(c+120,"commit_wb", false,-1, 0,0);
    tracep->declBus(c+121,"pc_cur", false,-1, 31,0);
    tracep->declBus(c+122,"inst", false,-1, 31,0);
    tracep->declBus(c+123,"uncache_read_wb", false,-1, 0,0);
    tracep->pushNamePrefix("CPU ");
    tracep->declBus(c+124,"PC_RESET_VALUE", false,-1, 31,0);
    tracep->declBus(c+125,"I_CACHE_DEPTH", false,-1, 31,0);
    tracep->declBus(c+125,"D_CACHE_DEPTH", false,-1, 31,0);
    tracep->declBus(c+118,"clk", false,-1, 0,0);
    tracep->declBus(c+119,"rstn", false,-1, 0,0);
    tracep->declBus(c+120,"commit_wb", false,-1, 0,0);
    tracep->declBus(c+121,"pc_cur", false,-1, 31,0);
    ...
    tracep->declBus(c+126,"mem_wdata_ex", false,-1, 31,0);
    ...
    tracep->declBus(c+127,"wstrb_ex", false,-1, 3,0);
    ...
    tracep->declBus(c+128,"ID_EX_stall", false,-1, 0,0);
    tracep->declBus(c+56,"ID_EX_flush", false,-1, 0,0);
    tracep->declBus(c+128,"EX_LS_stall", false,-1, 0,0);
    tracep->declBus(c+56,"EX_LS_flush", false,-1, 0,0);
    tracep->declBus(c+128,"LS_WB_stall", false,-1, 0,0);
    tracep->declBus(c+128,"LS_WB_flush", false,-1, 0,0);
    tracep->declBus(c+119,"commit_if1", false,-1, 0,0);
    tracep->declBus(c+58,"commit_if2", false,-1, 0,0);
    tracep->declBus(c+59,"commit_id", false,-1, 0,0);
    tracep->declBus(c+60,"commit_ex", false,-1, 0,0);
    tracep->declBus(c+61,"commit_ls", false,-1, 0,0);
    ...
    tracep->declQuad(c+62,"result_64", false,-1, 63,0);
    tracep->declBus(c+64,"result_div", false,-1, 31,0);
    tracep->declBus(c+65,"result_rem", false,-1, 31,0);
    tracep->declBus(c+66,"sign", false,-1, 1,0);
    tracep->declBus(c+67,"sr1_abs", false,-1, 31,0);
    tracep->declBus(c+68,"sr2_abs", false,-1, 31,0);
    ...
    tracep->declBus(c+130,"din3", false,-1, 31,0);
    tracep->declBus(c+130,"din4", false,-1, 31,0);
    ...
    tracep->declBus(c+56,"jump", false,-1, 0,0);
    tracep->declBus(c+31,"jump_target", false,-1, 31,0);
    tracep->declBit(c+69,"is_branch", false,-1);
    tracep->declBit(c+70,"is_jal", false,-1);
    tracep->declBit(c+71,"is_jalr", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+73,"load_type", false,-1, 2,0);
    tracep->declBus(c+34,"load_data", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("DCache_inst ");
    tracep->declBus(c+125,"DEPTH", false,-1, 31,0);
    tracep->declBus(c+118,"clk", false,-1, 0,0);
    ...
    tracep->declBus(c+128,"stall", false,-1, 0,0);
    tracep->declBus(c+74,"rdata_temp", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+77,"rf_rd_ls", false,-1, 4,0);
    tracep->declBus(c+78,"rf_rd_wb", false,-1, 4,0);
    tracep->declBus(c+52,"rf_we_ls", false,-1, 0,0);
    tracep->declBus(c+53,"rf_we_wb", false,-1, 0,0);
    tracep->declBus(c+79,"rf_rs1_ex", false,-1, 4,0);
    tracep->declBus(c+80,"rf_rs2_ex", false,-1, 4,0);
    ...
    tracep->declBus(c+23,"forward2_data", false,-1, 31,0);
    tracep->declBus(c+38,"mem_access_ex", false,-1, 4,0);
    tracep->declBus(c+81,"rf_rd_ex", false,-1, 4,0);
    tracep->declBus(c+82,"rf_rs1_id", false,-1, 4,0);
    tracep->declBus(c+83,"rf_rs2_id", false,-1, 4,0);
    tracep->declBus(c+56,"jump", false,-1, 0,0);
    tracep->declBus(c+31,"jump_target", false,-1, 31,0);
    tracep->declBus(c+56,"pc_set", false,-1, 0,0);
    tracep->declBus(c+56,"IF1_IF2_flush", false,-1, 0,0);
    ...
    tracep->declBit(c+132,"flush_by_load_use", false,-1);
    tracep->declBit(c+84,"is_load_ex", false,-1);
    ...
    tracep->declBus(c+85,"rdata_temp", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+124,"RESET_VALUE", false,-1, 31,0);
    tracep->declBus(c+118,"clk", false,-1, 0,0);
    tracep->declBus(c+119,"rstn", false,-1, 0,0);
    tracep->declBus(c+57,"stall", false,-1, 0,0);
    tracep->declBus(c+14,"next_pc", false,-1, 31,0);
    ...
    tracep->declBus(c+118,"clk", false,-1, 0,0);
    tracep->declBus(c+82,"raddr1", false,-1, 4,0);
    tracep->declBus(c+83,"raddr2", false,-1, 4,0);
    ...
    tracep->declBus(c+124,"PC_RESET_VAL", false,-1, 31,0);
    tracep->declBus(c+118,"clk", false,-1, 0,0);
    tracep->declBus(c+119,"rstn", false,-1, 0,0);
    tracep->declBus(c+128,"stall", false,-1, 0,0);
    tracep->declBus(c+56,"flush", false,-1, 0,0);
    ...
    tracep->declBus(c+119,"rstn", false,-1, 0,0);
    tracep->declBus(c+128,"stall", false,-1, 0,0);
    tracep->declBus(c+128,"flush", false,-1, 0,0);
    tracep->declBus(c+6,"pc_ls", false,-1, 31,0);
    tracep->declBus(c+11,"inst_ls", false,-1, 31,0);
    tracep->declBus(c+29,"alu_result_ls", false,-1, 31,0);
    tracep->declBus(c+32,"mem_rdata_ls", false,-1, 31,0);
    ...
    tracep->declBus(c+52,"rf_we_ls", false,-1, 0,0);
    tracep->declBus(c+61,"commit_ls", false,-1, 0,0);
    tracep->declBus(c+72,"read_ls", false,-1, 0,0);
    tracep->declBus(c+7,"pc_wb", false,-1, 31,0);
    tracep->declBus(c+12,"inst_wb", false,-1, 31,0);
    tracep->declBus(c+30,"alu_result_wb", false,-1, 31,0);
    tracep->declBus(c+33,"mem_rdata_wb", false,-1, 31,0);
...
VL_ATTR_COLD void VCPU___024root__trace_full_sub_0(VCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+58,(vlSelf->CPU__DOT__commit_if2));
    bufp->fullBit(oldp+59,(vlSelf->CPU__DOT__commit_id));
    bufp->fullBit(oldp+60,(vlSelf->CPU__DOT__commit_ex));
    bufp->fullBit(oldp+61,(vlSelf->CPU__DOT__commit_ls));
    bufp->fullQData(oldp+62,(vlSelf->CPU__DOT__ALU_inst__DOT__result_64),64);
    bufp->fullIData(oldp+64,(vlSelf->CPU__DOT__ALU_inst__DOT__result_div),32);
    bufp->fullIData(oldp+65,(vlSelf->CPU__DOT__ALU_inst__DOT__result_rem),32);
    bufp->fullCData(oldp+66,((((IData)(vlSelf->CPU__DOT__ALU_inst__DOT____VdfgTmp_h175d6d08__0) 
                               << 1U) | (vlSelf->CPU__DOT__alu_rs1 
                                         >> 0x1fU))),2);
    bufp->fullIData(oldp+67,(vlSelf->CPU__DOT__ALU_inst__DOT__sr1_abs),32);
    bufp->fullIData(oldp+68,(vlSelf->CPU__DOT__ALU_inst__DOT__sr2_abs),32);
    bufp->fullBit(oldp+69,((IData)((0x10U == (0x18U 
                                              & (IData)(vlSelf->CPU__DOT__br_type_ex))))));
    bufp->fullBit(oldp+70,(((IData)(vlSelf->CPU__DOT__Branch_inst__DOT____VdfgTmp_h8a7e5af4__0) 
                            & ((IData)(vlSelf->CPU__DOT__br_type_ex) 
                               >> 2U))));
    bufp->fullBit(oldp+71,(vlSelf->CPU__DOT__Branch_inst__DOT__is_jalr));
    bufp->fullBit(oldp+72,((1U & ((IData)(vlSelf->CPU__DOT__mem_access_ls) 
                                  >> 3U))));
    bufp->fullCData(oldp+73,((7U & (IData)(vlSelf->CPU__DOT__mem_access_ls))),3);
    bufp->fullIData(oldp+74,(vlSelf->CPU__DOT__DCache_inst__DOT__rdata_temp),32);
    bufp->fullCData(oldp+75,((0x1fU & (vlSelf->CPU__DOT__inst_id 
                                       >> 7U))),5);
    bufp->fullCData(oldp+76,((7U & (vlSelf->CPU__DOT__inst_id 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+77,((0x1fU & (vlSelf->CPU__DOT__inst_ls 
                                       >> 7U))),5);
    bufp->fullCData(oldp+78,((0x1fU & (vlSelf->CPU__DOT__inst_wb 
                                       >> 7U))),5);
    bufp->fullCData(oldp+79,((0x1fU & (vlSelf->CPU__DOT__inst_ex 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+80,((0x1fU & (vlSelf->CPU__DOT__inst_ex 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+81,((0x1fU & (vlSelf->CPU__DOT__inst_ex 
                                       >> 7U))),5);
    bufp->fullCData(oldp+82,((0x1fU & (vlSelf->CPU__DOT__inst_id 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+83,((0x1fU & (vlSelf->CPU__DOT__inst_id 
                                       >> 0x14U))),5);
    bufp->fullBit(oldp+84,((1U & ((IData)(vlSelf->CPU__DOT__mem_access_ex) 
                                  >> 3U))));
    bufp->fullIData(oldp+85,(vlSelf->CPU__DOT__ICache_inst__DOT__rdata_temp),32);
    bufp->fullIData(oldp+86,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[0]),32);
    bufp->fullIData(oldp+87,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[1]),32);
    bufp->fullIData(oldp+88,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[2]),32);
    bufp->fullIData(oldp+89,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[3]),32);
    bufp->fullIData(oldp+90,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[4]),32);
    bufp->fullIData(oldp+91,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[5]),32);
    bufp->fullIData(oldp+92,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[6]),32);
    bufp->fullIData(oldp+93,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[7]),32);
    bufp->fullIData(oldp+94,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[8]),32);
    bufp->fullIData(oldp+95,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[9]),32);
    bufp->fullIData(oldp+96,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[10]),32);
    bufp->fullIData(oldp+97,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[11]),32);
    bufp->fullIData(oldp+98,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[12]),32);
    bufp->fullIData(oldp+99,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[13]),32);
    bufp->fullIData(oldp+100,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[14]),32);
    bufp->fullIData(oldp+101,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[15]),32);
    bufp->fullIData(oldp+102,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[16]),32);
    bufp->fullIData(oldp+103,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[17]),32);
    bufp->fullIData(oldp+104,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[18]),32);
    bufp->fullIData(oldp+105,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[19]),32);
    bufp->fullIData(oldp+106,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[20]),32);
    bufp->fullIData(oldp+107,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[21]),32);
    bufp->fullIData(oldp+108,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[22]),32);
    bufp->fullIData(oldp+109,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[23]),32);
    bufp->fullIData(oldp+110,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[24]),32);
    bufp->fullIData(oldp+111,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[25]),32);
    bufp->fullIData(oldp+112,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[26]),32);
    bufp->fullIData(oldp+113,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[27]),32);
    bufp->fullIData(oldp+114,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[28]),32);
    bufp->fullIData(oldp+115,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[29]),32);
    bufp->fullIData(oldp+116,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[30]),32);
    bufp->fullIData(oldp+117,(vlSelf->CPU__DOT__Regfile_inst__DOT__rf[31]),32);
    bufp->fullBit(oldp+118,(vlSelf->clk));
    bufp->fullBit(oldp+119,(vlSelf->rstn));
    bufp->fullBit(oldp+120,(vlSelf->commit_wb));
    bufp->fullIData(oldp+121,(vlSelf->pc_cur),32);
    bufp->fullIData(oldp+122,(vlSelf->inst),32);
    bufp->fullBit(oldp+123,(vlSelf->uncache_read_wb));
    bufp->fullIData(oldp+124,(0x80000000U),32);
    bufp->fullIData(oldp+125,(8U),32);
    bufp->fullIData(oldp+126,(vlSelf->CPU__DOT__mem_wdata_ex),32);
    bufp->fullCData(oldp+127,(vlSelf->CPU__DOT__wstrb_ex),4);
