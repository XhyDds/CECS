...
VL_ATTR_COLD void VCPU___024root___stl_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    vlSelf->CPU__DOT__rf_we_id = (((((((((0x37U == 
                                          (0x7fU & vlSelf->CPU__DOT__inst_id)) 
                                         | (0x17U == 
                                            (0x7fU 
                                             & vlSelf->CPU__DOT__inst_id))) 
...
VL_ATTR_COLD void VCPU___024root___ctor_var_reset(VCPU___024root* vlSelf) {
    ...
    vlSelf->CPU__DOT__exp_code_id = VL_RAND_RESET_I(16);
    vlSelf->CPU__DOT__exp_code_ex = VL_RAND_RESET_I(16);
    vlSelf->CPU__DOT__exp_code_ls = VL_RAND_RESET_I(16);
    vlSelf->CPU__DOT__exp_code_wb = VL_RAND_RESET_I(16);
