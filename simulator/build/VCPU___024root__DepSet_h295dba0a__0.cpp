...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    if ((1U & ((~ (IData)(vlSelf->rstn)) | (IData)(vlSelf->CPU__DOT__EX_LS_flush)))) {
        ...
        vlSelf->CPU__DOT__exp_code_ls = vlSelf->CPU__DOT__exp_code_ex;
    ...
    if ((1U & ((~ (IData)(vlSelf->rstn)) | (IData)(vlSelf->CPU__DOT__ID_EX_flush)))) {
        vlSelf->CPU__DOT__exp_code_ex = 0U;
        ...
        vlSelf->CPU__DOT__exp_code_ex = vlSelf->CPU__DOT__exp_code_id;
    ...
    if ((0x100U & (IData)(vlSelf->CPU__DOT__exp_code_wb))) {
        if (vlSelf->CPU__DOT__exp_en_wb) {
            if ((0U == (3U & (vlSelf->CPU__DOT__CSR_inst__DOT__mstatus 
                              >> 1U)))) {
                vlSelf->CPU__DOT__mcause_in = 8U;
            } else if ((1U == (3U & (vlSelf->CPU__DOT__CSR_inst__DOT__mstatus 
                                     >> 1U)))) {
                vlSelf->CPU__DOT__mcause_in = 9U;
            } else if ((2U == (3U & (vlSelf->CPU__DOT__CSR_inst__DOT__mstatus 
                                     >> 1U)))) {
                vlSelf->CPU__DOT__mcause_in = 0xaU;
            } else if ((3U == (3U & (vlSelf->CPU__DOT__CSR_inst__DOT__mstatus 
                                     >> 1U)))) {
    ...
    vlSelf->CPU__DOT__exp_code_id = 0U;
    vlSelf->CPU__DOT__exp_en_id = 0U;
    if ((0x73U == vlSelf->CPU__DOT__inst_id)) {
        vlSelf->CPU__DOT__exp_code_id = (0x100U | (IData)(vlSelf->CPU__DOT__exp_code_id));
